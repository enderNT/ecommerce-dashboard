export default function DrawerFooter() {
    ...
    return(
        <footer className="footer bg-neutral text-neutral-content px-8 py-6 max-w-80">
          <nav>
            <h2 className="footer-title">Custommer Support</h2>
            <p className="text-wrap mb-5"> Ask your query, place request,
              or important issues. Our support team will contact 24/7 to you</p>
            ...
            <a target="_blank"
              ...
              className="link link-hover">Terms & Services Privacy Policy</a>
          </nav>
        </footer>
    )
}